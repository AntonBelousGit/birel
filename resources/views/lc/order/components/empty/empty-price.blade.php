<div class="wrapper-cont">
    ...
    <div class="edit-wrapper-box">
        ...
        <input id="share-type" type="text" class="i-f " disabled value="" placeholder="Enter the Type">
    </div>
    <div class="edit-wrapper-box">
        ...
        <input id="share-price" type="text" class="i-f " disabled value="" placeholder="Enter the Price">
    </div>
    <div class="edit-wrapper-box">
    ...
    <div class="edit-wrapper-box">
        ...
        <input id="volume" type="text" class="i-f " disabled value="" placeholder="Enter the Volume">
    </div>
</div>
