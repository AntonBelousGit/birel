                        ...
                        <div id="tabs1">
                            ...
                            <form class="tab-content active" action="{{ route('register') }}" method="POST">
                                ...
                                <div class="cont-l">
                                    ...
                                    <div class="box-input">
                                        <input class="i-f" type="text" placeholder="Name" name="name"
                                    ...
                                    <div class="box-input">
                                        <input class="i-f" type="text" placeholder="Surname" name="surname"
                                               value="{{ old('surname') }}" required autocomplete="surname">
                                    </div>
                                    <div class="box-input">
                                        <input class="i-f" type="text" placeholder="Fund address" name="fund_address"
                                               value="{{ old('fund_address') }}" required autocomplete="fund_address">
                                    </div>
                                    <div class="box-input">
                                        <input class="i-f" type="text" placeholder="Foundation fund name"
                                               name="fund_name" value="{{ old('fund_name') }}" required
                                               autocomplete="fund_name">
                                    </div>
                                </div>
                                <div class="cont-r">
                                    <div class="box-input">
                                        <input class="i-f" type="email" placeholder="Email" name="email"
                                    ...
                                    <div class="box-input">
                                        <input class="i-f" type="password" placeholder="Password" name="password"
                                    ...
                                    <div class="box-input">
                                        <input class="i-f" type="password" placeholder="Confirm password"
                            ...
                            <form class="tab-content" action="{{ route('register') }}" method="POST">
                                ...
                                <div class="cont-l">
                                    ...
                                    <div class="box-input">
                                        <input class="i-f" type="text" placeholder="Linkedin" name="linkedin"
